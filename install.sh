#!/bin/bash
myuname=$(uname | tr 'A-Z' 'a-z');myarch=$(uname -m)
...
curl -s https://myip.ipip.net | grep -oE "中国|China" 2>/dev/null && speed=https://gh-proxy.org/
dow_url="${speed}https://github.com/nasyt233/nweb/releases/download/$tag_name/$tag_name-$myuname-$myarch"
